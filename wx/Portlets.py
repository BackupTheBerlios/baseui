...
class Database ( wx.Panel ):
    ...
    def __init__( self, parent ):
        ...
        self.combobox_engine = wx.ComboBox( self, wx.ID_ANY, u"Combo!", wx.DefaultPosition, wx.DefaultSize, combobox_engineChoices, 0 )
        ...
        self.combobox_odbc = wx.ComboBox( self, wx.ID_ANY, u"Combo!", wx.DefaultPosition, wx.DefaultSize, combobox_odbcChoices, 0 )
        ...
        self.button_connect = wx.BitmapButton( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
        sizer_button.Add( self.button_connect, 0, wx.ALL|wx.ALIGN_RIGHT, 5 )
        
        sizer_content.Add( sizer_button, 1, wx.EXPAND, 5 )
        
        frame_database.Add( sizer_content, 1, wx.EXPAND, 5 )
        
        self.SetSizer( frame_database )
        self.Layout()
        frame_database.Fit( self )
...
class Login ( wx.Panel ):
    ...
    def __init__( self, parent ):
        ...
        self.combobox_user = wx.ComboBox( self, wx.ID_ANY, u"Combo!", wx.DefaultPosition, wx.DefaultSize, combobox_userChoices, 0 )
