...
""" + table_layout + """
    ...
    def get_foreign_key_column(self, attributes_lod, primary_key_column, referenced_table_name):
    ...
    def join(self, foreign_table=None, column_list=[], mode='outer', where=''):
